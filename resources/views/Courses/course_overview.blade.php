...
<!-- Main content -->
        ...
        <!-- Section Update modal -->
				...
				<div id="addSectionModal" class="modal fade" tabindex="-1">
					...
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							<form action="{{route('store-section')}}"  method="post" enctype="multipart/form-data" class="form-validate-jquery">
								@csrf
								<div class="modal-body">
									<input type="hidden" name="module_id" class="add_module_id" value="">
									<fieldset>
										<div class="form-group row">
										...
										<div class="form-group row">
											...
											<div class="col-lg-8">
											<textarea name="duration" class="form-control required" rows="8" cols="80"></textarea>
											</div>
										</div>
									</fieldset>
								</div>
                      ...
                      <!-- Section Area Starts Here -->
											<tr class="collapse table-success" id="module{{$module->id}}" >
												...
												<div class="card-header header-elements-lg-inline">
													...
													<div class="text-center">
														<a href="javascript:void(0);" class="btn btn-primary add-section" data-module_id="{{$module->id}}">Add Section</a>
													</div>
												</div>
												<div class="dropdown-divider"></div>
												<div class="table-responsive">
...
<script type="text/javascript">
	$(document).on('click','.add-section',function() {
		$('.add_module_id').val($(this).data('module_id'));
